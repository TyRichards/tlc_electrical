...
function load_js(){
	...
	wp_enqueue_script('infinite-scroll-script', get_template_directory_uri() . '/assets/js/vendor/infinitescroll.min.js');	
	wp_enqueue_script('masonry-script', get_template_directory_uri() . '/assets/js/vendor/masonry.pkgd.min.js');	
	wp_enqueue_script('images-loaded-script', get_template_directory_uri() . '/assets/js/vendor/imagesloaded.min.js');		
	// Custom JS
